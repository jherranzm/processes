...
@XmlRootElement(name="condiciontraficointernacionalpornivel")
public class CondicionTraficoInternacionalPorNivel 
    ...
    public CondicionTraficoInternacionalPorNivel() {
    }
