...
import telefonica.aaee.dao.exceptions.FicheroNotFoundException;
...
public class FicheroService {
	...
	@Transactional
	public void deleteByFichero(String fichero){
		executeSQLQuery("CALL 977r.977r_BorrarDatosPorFichero('"+ fichero +"')");
	}
